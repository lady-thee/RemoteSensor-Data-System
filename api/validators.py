...
class CustomMinimumLengthValidator(MinimumLengthValidator):
    def __init__(self, min_length=8):
        ...
        self.message = _('This password is too short. It must contain at least {min_length} characters.').format(min_length=self.min_length)
...
class CustomNumericValidator(NumericPasswordValidator):
    def __init__(self, min_count=1):
        ...
        self.message = _('This password must contain at least {min_count} number.').format(min_count=self.min_count)
